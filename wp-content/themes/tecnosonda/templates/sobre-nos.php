...
<section id="page-sobre-nos" class="page">
    ...
    <div class="container-fluid container-sobre show-after" style="background-image: url(<?= $imagem_diferenciais_compromisso['url']; ?>);background-repeat: no-repeat;background-position: top right;padding-bottom: 100px;">
        <div class="container">
