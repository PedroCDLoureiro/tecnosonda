...
<section id="page-nossa-historia" class="page">
    ...
    <?php if (have_rows('marcos_dos_ultimos_anos')): ?>
        <div class="container-fluid container-marcos">
            <div class="marcos py-5">
                <div class="d-flex align-items-center justify-content-between top-marcos mb-4">
                    <div class="section-title white-title">
                        <h2>Marcos Dos <span>Últimos 25 Anos:</span></h2>
                    </div>
                    <?php if($marcos && count($marcos) > 3) : ?>
                        <div class="controls-slider">
                            <button class="prev-marcos">
                ...
                <div class="marcos-wrapper scroll-slider">
                    ...
                    ?>
                        <div class="marco-item" data-indice="<?= $indice; ?>">
                            <div class="texts">
                                <h3><?= esc_html($periodo); ?></h3>
                                <div class="d-flex justify-content-between itens-marco">
