...
<section id="page-category" class="page page-todas-as-noticias">    
        ...
        <div id="top-page" class="container">
            <div class="row">
                <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                    <h1 class="text-white fw-bold mb-4">Todas as notícias</h1>
                    <div class="box-category">
                        ...
                        <div class="d-flex flex-wrap mt-4 others-categories">
                            <?php
    ...
    <div id="todas-as-noticias" class="container-fluid bg-primary pt-lg-0 pt-5 show-before section-category">
